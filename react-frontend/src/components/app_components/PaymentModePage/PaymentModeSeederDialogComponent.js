...
import seederData from "./paymentMode.seeder.json";
...
const PaymentModeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(PaymentModeSeederDialogComponent);
