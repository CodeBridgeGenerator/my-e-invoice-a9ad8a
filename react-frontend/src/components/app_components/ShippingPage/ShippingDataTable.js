...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.shippingRecipientsName}</p>
...
const pTemplate13 = (rowData, { rowIndex }) => <p >{rowData.referenceNumberOfCustomsFormNo2}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="shippingRecipientsName" header="Shipping Recipient's Name" body={pTemplate0} filter={selectedFilterFields.includes("shippingRecipientsName")} hidden={selectedHideFields?.includes("shippingRecipientsName")}  sortable style={{ minWidth: "8rem" }} />
