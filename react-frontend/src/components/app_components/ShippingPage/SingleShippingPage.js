    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleShippingId, { query: { $populate: [            {
                ...
                service: "users",
                select: ["name"],
              },"shippingRecipientsAddressCountryName","shippingRecipientsAddressStateName","shippingRecipientsIdentifierType"] }})
            .then((res) => {
                set_entity(res || {});
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Shipping Recipient's Name</label><p className="m-0 ml-3" >{_entity?.shippingRecipientsName}</p></div>
