...
const [shippingRecipientsIdentifierType, setShippingRecipientsIdentifierType] = useState([])
    ...
    useEffect(() => {
        ...
        if (!_.isEmpty(props?.entity)) {
            init = initilization({ ...props?.entity, ...init }, [shippingRecipientsAddressCountryName,shippingRecipientsAddressStateName,shippingRecipientsIdentifierType], setError);
        }
        set_entity({...init});
        setError({});
    }, [props.show]);
