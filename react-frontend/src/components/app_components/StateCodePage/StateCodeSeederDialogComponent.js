...
import seederData from "./stateCode.seeder.json";
...
const StateCodeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(StateCodeSeederDialogComponent);
