...
import seederData from "./taxType.seeder.json";
...
const TaxTypeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TaxTypeSeederDialogComponent);
