...
const InvoicesPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("invoices")
            .find({ query: { $limit: 10000 , invoiceType : urlParams.singleEInvoiceTypesId ,classification : urlParams.singleClassificationCodesId ,countryOfOrigin : urlParams.singleCountryCodesId ,taxType : urlParams.singleTaxTypesId ,taxType1 : urlParams.singleTaxTypesId ,team : urlParams.singleTeamId ,buyer : urlParams.singleBuyersId ,supplier : urlParams.singleSuppliersId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
                ...
                select: ["name"],
                        ...
                        path : "invoiceType",
                        service : "e_invoice_types",
                        select:["eInvoiceTypes"]
                    },{
                        path : "classification",
                        service : "classification_codes",
