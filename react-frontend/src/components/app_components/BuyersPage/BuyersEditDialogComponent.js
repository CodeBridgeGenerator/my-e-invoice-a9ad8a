...
paymentMode: _entity?.paymentMode?._id,
        ...
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info buyers updated successfully" });
...
const paymentModeOptions = paymentMode.map((elem) => ({ name: elem.name, value: elem.value }));
    ...
    return (
        <Dialog header="Edit Buyers" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="buyers-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="buyersAddressPostalZone" className="w-full mb-3 p-inputtext-sm" value={_entity?.buyersAddressPostalZone} onChange={(e) => setValByKey("buyersAddressPostalZone", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="buyersContactNumber" className="w-full mb-3 p-inputtext-sm" value={_entity?.buyersContactNumber} onChange={(e) => setValByKey("buyersContactNumber", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="currencyExchangeRate" className="w-full mb-3 p-inputtext-sm" value={_entity?.currencyExchangeRate} onChange={(e) => setValByKey("currencyExchangeRate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
