...
const [paymentMode, setPaymentMode] = useState([]);
    ...
    useEffect(() => {
        ...
        client
            .service("buyer")
            .get(urlParams.singleBuyerId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
                ...
                service: "users",
                select: ["name"],
              },"identifierType","buyersAddressCountryName","buyersAddressStateName","theFirstBuyersContactNumber","invoiceCurrency","frequencyOfBilling","paymentMode"] }})
            .then((res) => {
                set_entity(res || {});
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>buyer/{urlParams.singleBuyerId}</p> */}
            </div>
            <div className="card w-full">
                <div className="grid ">

            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Buyer's name (*)</label><p className="m-0 ml-3" >{_entity?.buyersName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Payment Mode</label>
      ...
      <CommentsSection
        recordId={urlParams.singleBuyerId}
        user={props.user}
        alert={props.alert}
        serviceName="buyer"
      />
...
export default connect(mapState, mapDispatch)(SingleBuyerPage);
