...
client.service("paymentMode")
    ...
    const onRun = async () => {
        let fakeData = buyerFakerFactory(props.user,fakerCount,identifierTypeIds,buyersAddressCountryNameIds,buyersAddressStateNameIds,theFirstBuyersContactNumberIds,invoiceCurrencyIds,frequencyOfBillingIds,paymentModeIds);
...
export default connect(mapState, mapDispatch)(BuyerFakerDialogComponent);
