...
import seederData from "./measurement.seeder.json";
...
const MeasurementSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MeasurementSeederDialogComponent);
