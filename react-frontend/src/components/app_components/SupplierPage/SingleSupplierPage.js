  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Supplier's Name</label><p className="m-0 ml-3" >{_entity?.suppliersName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Identifier Type</label><p className="m-0 ml-3" >{_entity?.identifierType}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">The first Supplier's contact number</label><p className="m-0 ml-3" >{_entity?.theFirstSuppliersContactNumber}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Country name</label><p className="m-0 ml-3" >{_entity?.countryName}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">State name</label><p className="m-0 ml-3" >{_entity?.stateName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Postal zone</label><p className="m-0 ml-3" >{Number(_entity?.postalZone)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">PrePayment Date</label><p className="m-0 ml-3" ><Calendar id="prePaymentDate" value={new Date(_entity?.prePaymentDate)} disabled={true} hourFormat="24"  /></p></div>
