...
import seederData from "./classificationCode.seeder.json";
...
const ClassificationCodeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ClassificationCodeSeederDialogComponent);
