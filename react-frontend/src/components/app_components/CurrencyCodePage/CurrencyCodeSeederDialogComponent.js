...
import seederData from "./currencyCode.seeder.json";
...
const CurrencyCodeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CurrencyCodeSeederDialogComponent);
