...
export default (user,count,identifierTypeIds,theFirstSuppliersContactNumberIds,countryNameIds,stateNameIds,teamIds,invoiceIdIds) => {
    let data = [];
    for (let i = 0; i < count; i++) {
        const fake = {
suppliersName: faker.lorem.sentence("8"),
