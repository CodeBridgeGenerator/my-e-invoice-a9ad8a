...
const [countryNameIds, setcountryNameIds] = useState();
const [stateNameIds, setstateNameIds] = useState();
...
client.service("invoices")
    ...
    const onRun = async () => {
        let fakeData = suppliersFakerFactory(props.user,fakerCount,identifierTypeIds,theFirstSuppliersContactNumberIds,countryNameIds,stateNameIds,teamIds,invoiceIdIds);
