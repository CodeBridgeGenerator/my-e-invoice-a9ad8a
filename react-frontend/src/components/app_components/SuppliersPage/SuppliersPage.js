...
const SuppliersPage = (props) => {
    ...
    useEffect(() => {
        ...
        client
            .service("suppliers")
            .find({ query: { $limit: 10000 , identifierType : urlParams.singleIdentifyTypeId ,theFirstSuppliersContactNumber : urlParams.singlePhoneNumberPrefixId ,countryName : urlParams.singleCountryCodesId ,stateName : urlParams.singleStateCodesId ,team : urlParams.singleTeamId ,invoiceId : urlParams.singleInvoicesId  , $populate : [
                {
                path: "createdBy",
                service: "users",
                select: ["name"],
