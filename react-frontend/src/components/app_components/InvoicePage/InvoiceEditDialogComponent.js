...
no: _entity?.no,
classification: _entity?.classification,
...
detailsOfExemption: _entity?.detailsOfExemption,
amountExempted: _entity?.amountExempted,
discountRate: _entity?.discountRate,
discountAmount: _entity?.discountAmount,
description1: _entity?.description1,
feeChargeRate: _entity?.feeChargeRate,
feeChargeAmount: _entity?.feeChargeAmount,
taxType1: _entity?.taxType1?._id,
...
discountAmount1: _entity?.discountAmount1,
description3: _entity?.description3,
feeAmount: _entity?.feeAmount,
description4: _entity?.description4,
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="no" className="w-full mb-3 p-inputtext-sm" value={_entity?.no} onChange={(e) => setValByKey("no", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
            {!_.isEmpty(error["no"]) && (
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="totalExcludingTax" className="w-full mb-3 p-inputtext-sm" value={_entity?.totalExcludingTax} onChange={(e) => setValByKey("totalExcludingTax", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="taxAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.taxAmount} onChange={(e) => setValByKey("taxAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="amountExempted" className="w-full mb-3 p-inputtext-sm" value={_entity?.amountExempted} onChange={(e) => setValByKey("amountExempted", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="discountRate" className="w-full mb-3 p-inputtext-sm" value={_entity?.discountRate} onChange={(e) => setValByKey("discountRate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="discountAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.discountAmount} onChange={(e) => setValByKey("discountAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="feeChargeRate" className="w-full mb-3 p-inputtext-sm" value={_entity?.feeChargeRate} onChange={(e) => setValByKey("feeChargeRate", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="feeChargeAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.feeChargeAmount} onChange={(e) => setValByKey("feeChargeAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="totalTaxableAmountPerTaxType" className="w-full mb-3 p-inputtext-sm" value={_entity?.totalTaxableAmountPerTaxType} onChange={(e) => setValByKey("totalTaxableAmountPerTaxType", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="totalTaxAmountPerTaxType" className="w-full mb-3 p-inputtext-sm" value={_entity?.totalTaxAmountPerTaxType} onChange={(e) => setValByKey("totalTaxAmountPerTaxType", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="amountExemptedFromTax" className="w-full mb-3 p-inputtext-sm" value={_entity?.amountExemptedFromTax} onChange={(e) => setValByKey("amountExemptedFromTax", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="discountAmount1" className="w-full mb-3 p-inputtext-sm" value={_entity?.discountAmount1} onChange={(e) => setValByKey("discountAmount1", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="feeAmount" className="w-full mb-3 p-inputtext-sm" value={_entity?.feeAmount} onChange={(e) => setValByKey("feeAmount", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
