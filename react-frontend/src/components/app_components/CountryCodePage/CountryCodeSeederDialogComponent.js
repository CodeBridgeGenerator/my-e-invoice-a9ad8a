...
import seederData from "./countryCode.seeder.json";
...
const CountryCodeSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CountryCodeSeederDialogComponent);
